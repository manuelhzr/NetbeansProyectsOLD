...
public class Eliminar extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        resultado=Instancias.getInstance().Buscar(bus);
        if (resultado!=-1) {
            CUENTA res=Instancias.getInstance().getListacuenta(resultado);
    ...
    private void BorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BorrarActionPerformed
        ...
        if (r == 0) {
            if (Instancias.getInstance().Eliminarcuenta(resultado) == true) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        limpiar();
        Instancias.getInstance().getEliminar().setVisible(false);
