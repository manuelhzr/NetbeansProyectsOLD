...
public class RealizarTransaccion extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (res!=-1) {
            cuenta=Instancias.getInstance().getListacuenta(res);
            habilitar(true);
    ...
    private void guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarActionPerformed
        // TODO add your handling code here:
        if (Instancias.getInstance().getListacuenta(res).getPosicionactual() < Instancias.getInstance().getListacuenta(res).getNmovimiento()) {
            if (consignacion.isSelected() || Retiro.isSelected()) {
                ...
                if (consignacion.isSelected()) {
                    ...
                    Instancias.getInstance().getListacuenta(res).Consignaciones(val, Mov);
                }
                if (Retiro.isSelected()) {
                    Mov.setQuienRealiza(Instancias.getInstance().getListacuenta(res).getDatoscliente().getNombre());
                    Mov.setTipo("Retiro");
                    Instancias.getInstance().getListacuenta(res).Retiro(val, Mov);
                }

                JOptionPane.showMessageDialog(rootPane, "Operacion realizada exitosamente");
                limpiar();
                Instancias.getInstance().getRealizartransaccion().setVisible(false);
