...
public class Ventana extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton4.setText("Llenar aleatorio");
        ...
        jLabel2.setText("cant. Pares");

        jLabel3.setText("cant. Impares");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(tam, javax.swing.GroupLayout.PREFERRED_SIZE, 53, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(suma, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE)
                                .addComponent(impares, javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(pares, javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(vector, javax.swing.GroupLayout.Alignment.LEADING)))))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        obj.setTam(Integer.parseInt(tam.getText()));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        for (int i = 0; i < obj.getTam(); i++) {
            obj.setVector(i, Integer.parseInt(JOptionPane.showInputDialog("Ingrese un valor")));
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String vect="";
        for (int i = 0; i < obj.getTam(); i++) {
            vect+=String.valueOf(obj.getVector(i)+" ");
        }
        
        vector.setText(vect);
        pares.setText(String.valueOf(obj.pares()));
        impares.setText(String.valueOf(obj.Impares()));
        suma.setText(String.valueOf(obj.sumaMitades()));
